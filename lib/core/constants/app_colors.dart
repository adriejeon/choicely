...
/// vocatch 프로젝트의 컬러 팔레트를 기반으로 합니다.
class AppColors {
  ...
  // Tarot & Intuitive Colors (추가 - 타로카드 테마용)
  static const Color mystical = Color(0xFF6B46C1);
  static const Color mysticalLight = Color(0xFF9F7AEA);
  static const Color mysticalDark = Color(0xFF553C9A);
}
